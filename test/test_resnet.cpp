...
TEST(test_model, resnet) {
  using namespace kuiper_infer;
  const std::string& param_path = "/home/chengyifei/workspace/learn_infer/github/KuiperCourse/tmp/resnet18_batch1.pnnx.param";///home/chengyifei/workspace/learn_infer/github/KuiperCourse/tmp/resnet18_batch1.pnnx.param
  const std::string& weight_path = "/home/chengyifei/workspace/learn_infer/github/KuiperCourse/tmp/resnet18_batch1.pnnx.bin";
