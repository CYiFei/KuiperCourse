...
TEST(test_net, forward_yolo1) {
  using namespace kuiper_infer;
  RuntimeGraph graph("/home/chengyifei/workspace/learn_infer/github/KuiperCourse/tmp/demo/yolov5n_small.pnnx.param",
                     "/home/chengyifei/workspace/learn_infer/github/KuiperCourse/tmp/demo/yolov5n_small.pnnx.bin");
  ...
  for (int i = 0; i < batch_size; ++i) {
    std::string file_path = "/home/chengyifei/workspace/learn_infer/github/KuiperCourse/tmp/" + std::to_string(i + 1) + ".csv";
